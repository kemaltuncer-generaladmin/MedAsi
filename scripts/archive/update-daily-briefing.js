const fs = require('fs');
const path = 'app/(dashboard)/daily-briefing/page.tsx';

const dailyBriefingCode = `"use client";
...
try {
  fs.writeFileSync(path, dailyBriefingCode);
  console.log("✅ Günlük Brifing Modülü (v1.0) Merkezi Beyne Bağlandı!");
} catch (e) {
