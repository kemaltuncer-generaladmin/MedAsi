...
const SERVICE_ROLE_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InpqZXpxd2Nqcml4a2VtZG1yZG9xIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc3NTQ5NzUzMSwiZXhwIjoyMDkxMDczNTMxfQ.HcVRwR3X8HtdzuHodbqStdDGhzutMUehQfnY5AK71jM'
...
async function main() {
  ...
  const user = await prisma.user.upsert({
    ...
    update: { role: 'admin', name: 'Kemal Tuncer', packageId: pkg.id },
    create: {
      id: supabaseUserId,
      email: ADMIN_EMAIL,
      name: 'Kemal Tuncer',
