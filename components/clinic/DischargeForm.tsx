...
import { dischargeSchema, type DischargeInput } from '@/lib/schemas/clinic/shared'
...
export function DischargeForm({ patientId, onSaved }: DischargeFormProps) {
  ...
  const doExport = () => {
    ...
    if (v.followUp) doc.text(`Kontrol: ${v.followUp}`, 14, 56, { maxWidth: 180 })
    ...
    <Card variant="bordered" className="rounded-xl p-6 sm:p-8">
      <div className="mb-6 flex items-center justify-between gap-3">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-xl font-bold text-[var(--color-text-primary)]">Taburcu</h3>
        </div>
