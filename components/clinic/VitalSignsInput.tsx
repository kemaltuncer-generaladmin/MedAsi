  ...
  return (
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
      <Input
        ...
        onChange={(e) =>
          onChange({ ...value, temperature: toNum(e.target.value) })
        }
        className="h-11"
      />
      <Input
      ...
      <Input
        ...
        onChange={(e) =>
          onChange({ ...value, systolic: toNum(e.target.value) })
        }
        className="h-11"
      />
      <Input
        ...
        onChange={(e) =>
          onChange({ ...value, diastolic: toNum(e.target.value) })
        }
        className="h-11"
      />
      <Input
      ...
      <Input
        ...
        onChange={(e) =>
          onChange({ ...value, respiratoryRate: toNum(e.target.value) })
        }
        className="h-11"
      />
    </div>
