...
const PLANS = [
  {
    ...
    missing: ["Yapay zeka özellikleri yok"],
    cta: "Hemen Başla",
    href: "/register",
    ctaStyle: "border",
  },
  {
    ...
    features: [
      ...
      "AI Flashcard üretici (Gemini)",
      "AI Soru açıklama asistanı",
      "Spot not AI özetleyici",
      "Soru bankası (50 soru/gün)",
      "Kişisel öğrenme analizi",
    ],
    missing: ["AI Tanı Asistanı yok", "Vaka RPG yok"],
  ...
  },
  {
    ...
    features: [
      ...
      "Vaka RPG Simülasyonu",
      "Medikal Terminal",
      "OSCE & Sözlü sınav AI'ı",
      "TUS hazırlık AI koçu",
      "Klinik Yönetim (sınırsız hasta)",
      "Öncelikli destek",
    ],
    missing: [],
    cta: "14 Gün Ücretsiz Dene",
  ...
  },
  {
    ...
    features: [
      ...
      "Toplu lisans indirimi",
      "Fakülte/sınıf yönetimi",
      "Öğrenci ilerleme takibi",
      "Özel SSO entegrasyonu",
...
const FAQ = [
  ...
  },
  {
    ...
    a: "Giriş planında aylık ₺99 yerine ₺79/ay ödersiniz (yıllık ₺948 yerine ₺948 → yıllık ~%20 indirim). Pro planında aylık ₺249 yerine ₺199/ay ödersiniz.",
  },
  {
