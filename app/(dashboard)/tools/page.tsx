    ...
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="text-[var(--color-text-secondary)]">
          Klinik karar desteği için hesaplayıcılar ve skorlama sistemleri
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {tools.map((tool) => (
          <Link key={tool.href} href={tool.href}>
            <Card
              variant="bordered"
              className="hover:border-[var(--color-primary)]/50 transition-all cursor-pointer group p-6"
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <span
                    className="inline-block mt-3 text-xs px-2 py-1 rounded-full bg-[var(--color-surface-elevated)] border border-[var(--color-border)]"
