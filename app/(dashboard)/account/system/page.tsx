...
export default function SystemPage() {
  ...
  function handleClearCache() {
    const confirmed = window.confirm(
      "Tüm medasi_* önbellek verileri silinecek. Bu işlem geri alınamaz. Devam etmek istiyor musunuz?",
    );
    if (!confirmed) return;
  ...
  function handleDeleteAccount() {
    toast.error(
      "Hesap silme özelliği şu an kullanılamıyor. Destek ekibiyle iletişime geçin.",
      { duration: 5000 },
    );
  }
    ...
    <div className="max-w-2xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-sm text-[var(--color-text-secondary)] mt-1">
          Görünüm, dil ve veri tercihlerinizi yönetin
        </p>
      </div>
      ...
      <Card variant="bordered">
        ...
        <CardContent>
          ...
          <p className="text-xs text-[var(--color-text-secondary)] mt-3">
            Not: Açık tema ve sistem teması görsel tercih olarak kaydedilir.
            Uygulama şu an karanlık modda çalışmaktadır.
          </p>
        </CardContent>
      </Card>
      ...
      <Card variant="bordered">
        ...
        <CardContent>
          <div className="space-y-2">
            <div className="flex items-center justify-between p-3 rounded-lg border border-[var(--color-primary)] bg-[var(--color-primary)]/5 cursor-pointer">
            ...
            <div className="flex items-center justify-between p-3 rounded-lg border border-[var(--color-border)] bg-[var(--color-surface-elevated)] opacity-60 cursor-not-allowed">
              <div className="flex items-center gap-3">
                <span className="text-lg">🇬🇧</span>
          ...
          <div className="space-y-4">
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <p className="text-xs text-[var(--color-text-secondary)] mt-0.5">
                  Tüm yerel uygulama verilerini ve önbelleği siler
                </p>
              </div>
              <Button
                variant="ghost"
            ...
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <p className="text-xs text-[var(--color-text-secondary)] mt-0.5">
                  Yerel verilerinizi JSON formatında dışa aktarın
                </p>
              </div>
              <Button
                variant="ghost"
      ...
      <Card variant="bordered">
        ...
        <CardContent>
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between py-2">
              ...
              <button
                ...
                onClick={() =>
                  toast("GitHub linki yakında eklenecek", { icon: "🔗" })
                }
              >
          ...
          <p className="text-xs text-[var(--color-text-secondary)] mt-4 pt-3 border-t border-[var(--color-border)]">
            MEDASI — Türk tıp öğrencileri ve hekimler için yapay zeka destekli
            eğitim platformu. © 2026 Tüm hakları saklıdır.
          </p>
        </CardContent>
      </Card>
    </div>
