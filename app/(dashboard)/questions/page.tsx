...
const items = [
  {
    ...
    icon: BookMarked,
    title: "Soru Bankası",
    desc: "Konu bazlı soru havuzu",
    color: "var(--color-primary)",
  },
  {
    href: "/questions/hatali",
    icon: AlertCircle,
    title: "Hatalı Sorular",
    desc: "Yanlış cevapladığın sorular",
  ...
  },
  {
    ...
    desc: "Yapay zeka destekli soru oluşturma",
    color: "var(--color-primary)",
  },
  {
    href: "/questions/fabrika",
    icon: Factory,
    title: "Soru Fabrikası",
    desc: "Toplu soru üretimi ve yönetimi",
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-[var(--color-text-secondary)] text-sm">
            Soru bankası ve pratik modülleri
          </p>
        </div>
      </div>
