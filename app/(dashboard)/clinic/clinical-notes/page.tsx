  ...
  return (
    <div className="flex flex-col gap-5">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-3xl font-bold text-[var(--color-text-primary)]">Klinik Notlarım</h1>
          <p className="text-[var(--color-text-secondary)]">Hasta bazlı klinik notlar</p>
        </div>
      </div>
      <div>
      ...
      {selectedId && <NoteEditor patientId={selectedId} />}
    </div>
  )
}
