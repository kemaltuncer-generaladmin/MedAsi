...
const items = [
  {
    ...
    icon: CreditCard,
    title: "Flashcard",
    desc: "Klasik kart bazlı çalışma",
    color: "var(--color-primary)",
  },
  {
    href: "/flashcards/spot-notlar",
    icon: StickyNote,
    title: "Spot Notlar",
    desc: "Kısa ve etkili hafıza notları",
  ...
  },
  {
    ...
    icon: Sparkles,
    title: "AI Flashcard",
    desc: "Yapay zeka ile otomatik kart oluşturma",
    color: "var(--color-primary)",
  },
];
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-[var(--color-text-secondary)] text-sm">
            Hızlı tekrar ve hafıza modülleri
          </p>
        </div>
      </div>
