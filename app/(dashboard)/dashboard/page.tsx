...
const comingSoon = [
  { title: "Soru Fabrikası", href: "/questions/fabrika" },
  { title: "Sözlü Sınav", href: "/exams/sozlu" },
  { title: "Zilli Sınav", href: "/exams/zilli" },
  { title: "AI Flashcard", href: "/flashcards/ai" },
  { title: "Akıllı Asistan", href: "/source/akilli-asistan" },
  { title: "Lab Yorumlama", href: "/lab-viewing" },
];
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-[var(--color-text-secondary)] text-sm">
            Hoş geldiniz — tüm modüllere buradan erişebilirsiniz
          </p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-3">
          {quickLinks.map((link) => (
            <Link key={link.href} href={link.href}>
              <Card
                variant="bordered"
                className="p-4 hover:border-[var(--color-primary)]/50 transition-all cursor-pointer group h-full"
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between">
                      ...
                      <ChevronRight
                        size={12}
                        className="text-[var(--color-text-secondary)] group-hover:text-[var(--color-primary)] transition-colors shrink-0"
                      />
                    </div>
