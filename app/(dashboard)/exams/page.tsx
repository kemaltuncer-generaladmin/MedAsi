...
const items = [
  {
    ...
    icon: MonitorPlay,
    title: "OSCE Sınavı",
    desc: "Objektif yapılandırılmış klinik sınav",
  ...
  },
  {
    ...
    icon: Mic,
    title: "Sözlü Sınav",
    desc: "Sözlü sınav simülasyonu",
    color: "var(--color-success)",
  },
  {
    href: "/exams/kuramsal",
    icon: BookOpen,
    title: "Kuramsal Sınav",
    desc: "Çoktan seçmeli sınav modülü",
  ...
  },
  {
    ...
    icon: Zap,
    title: "Zilli Sınav",
    desc: "Yapay zeka destekli adaptif sınav",
    color: "var(--color-primary)",
  },
];
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-[var(--color-text-secondary)] text-sm">
            Klinik sınav hazırlık modülleri
          </p>
        </div>
      </div>
